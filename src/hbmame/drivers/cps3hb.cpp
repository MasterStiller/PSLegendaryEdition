...
ROM_START( sfiiihc01 )
	...
	ROM_REGION( 0x200000, "simm1.0", 0 )
	ROM_LOAD( "sfiii-simm1_hc01.0", 0x00000, 0x200000, CRC(2858434c) SHA1(528b9b3716a8384bca1206a6a3863dde5a4c06f4) )
    ROM_IGNORE( 0x254F4D )
	ROM_REGION( 0x200000, "simm1.1", 0 )
	ROM_LOAD( "sfiii-simm1_hc01.1", 0x00000, 0x200000, CRC(75d3a584) SHA1(d2f9809d0614498bf6538b8c24eb172cd37906de) )
    ROM_IGNORE( 0x254F47 )
	ROM_REGION( 0x200000, "simm1.2", 0 )
	ROM_LOAD( "sfiii-simm1_hc01.2", 0x00000, 0x200000, CRC(9a9c8312) SHA1(14d7ba6aa7186c2df1a403191d658c24bc0a5560) )
    ROM_IGNORE( 0x254F47 )
	ROM_REGION( 0x200000, "simm1.3", 0 )
	ROM_LOAD( "sfiii-simm1_hc01.3", 0x00000, 0x200000, CRC(d338a53f) SHA1(4814c416b37914dbfb50fd008a1b8b21f7facf33) )
    ROM_IGNORE( 0x254F47 )
...
ROM_START( sfiii2hc02 )
	...
	ROM_REGION( 0x200000, "simm1.0", 0 )
	ROM_LOAD( "sfiii2-simm_hc02.0", 0x00000, 0x200000, CRC(2d666f0b) SHA1(58e40d55054799f2bcfca72b601a9149ab600a70) )
	ROM_IGNORE( 0x254F4B )
	ROM_REGION( 0x200000, "simm1.1", 0 )
	ROM_LOAD( "sfiii2-simm_hc02.1", 0x00000, 0x200000, CRC(2a3a8ef6) SHA1(c3d058e4dfb141a0e63083aebaded501037dd544) )
    ROM_IGNORE( 0x254F4C )
	ROM_REGION( 0x200000, "simm1.2", 0 )
	ROM_LOAD( "sfiii2-simm_hc02.2", 0x00000, 0x200000, CRC(161d2206) SHA1(b57303a9b38010fdd2c4c05e08e06ae654b86341) )
    ROM_IGNORE( 0x254F4C )
	ROM_REGION( 0x200000, "simm1.3", 0 )
	ROM_LOAD( "sfiii2-simm_hc02.3", 0x00000, 0x200000, CRC(87ded8a3) SHA1(64be027af5507875bf2617393b6fa9c7cc305255) )
    ROM_IGNORE( 0x254F4B )
...
ROM_START( sfiii3hc01 ) //sfiii3ws
	...
	ROM_REGION( 0x200000, "simm5.6", 0 )
	ROM_LOAD( "sfiii3-simm5_hc01.6", 0x00000, 0x200000, CRC(c59e5cc6) SHA1(6d3ca8a319e7f7debcd853d5862ffaa2f760ae5e) )
	ROM_IGNORE( 0x254F4A )
	ROM_REGION( 0x200000, "simm5.7", 0 )
	ROM_LOAD( "sfiii3-simm5_hc01.7", 0x00000, 0x200000, CRC(411d6285) SHA1(7cc58774db896801643d2d04e4c6dd956003e9f2) )
    ROM_IGNORE( 0x254F4A )
...
ROM_START( sfiii3hc04 )
	...
	ROM_REGION( 0x200000, "simm1.0", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.0", 0x00000, 0x200000, CRC(11dfd3cd) SHA1(de7cea6021b0e92586531990c70f035d327f581e) ) // crc collision
	ROM_IGNORE( 0x254F4B )
	ROM_REGION( 0x200000, "simm1.1", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.1", 0x00000, 0x200000, CRC(c50585e6) SHA1(9486ae732e229f6bfa6bd4ebdc49802a3cfa5649) ) // crc collision
	ROM_IGNORE( 0x254F4C )
	ROM_REGION( 0x200000, "simm1.2", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.2", 0x00000, 0x200000, CRC(8e011d9b) SHA1(65ec49d694924f8283e53adc3877eab851dd49f0) ) // crc collision
	ROM_IGNORE( 0x254F4F )
	ROM_REGION( 0x200000, "simm1.3", 0 )
	ROM_LOAD( "sfiii3-simm1_hc04.3", 0x00000, 0x200000, CRC(dca8d92f) SHA1(bae290f473132df058248c7b012a5e602866a4a2) ) // crc collision
    ROM_IGNORE( 0x254F4B )
...
ROM_START( sfiii3hc05 ) //sfiii4n
	...
	ROM_REGION( 0x200000, "simm1.0", 0 )
	ROM_LOAD( "sfiii3-simm1_hc05.0", 0x00000, 0x200000, CRC(11dfd3cd) SHA1(29b259d595cce0051a903ea8b46f054c2a9fb8b2) ) // crc collision
	ROM_IGNORE( 0x254F4B )
	ROM_REGION( 0x200000, "simm1.1", 0 )
	ROM_LOAD( "sfiii3-simm1_hc05.1", 0x00000, 0x200000, CRC(c50585e6) SHA1(6a6fc852c5de629e28547223ec00405b2469bca1) ) // crc collision
	ROM_IGNORE( 0x254F4C )
	ROM_REGION( 0x200000, "simm1.2", 0 )
	ROM_LOAD( "sfiii3-simm1_hc05.2", 0x00000, 0x200000, CRC(8e011d9b) SHA1(6d41632c6b4295058fc2e923ef808b22170f29b5) ) // crc collision
	ROM_IGNORE( 0x254F4B )
	ROM_REGION( 0x200000, "simm1.3", 0 )
	ROM_LOAD( "sfiii3-simm1_hc05.3", 0x00000, 0x200000, CRC(dca8d92f) SHA1(7cd07ddc75f943f5e5c9dcc1bc4e33459e97fdf3) ) // crc collision
    ROM_IGNORE( 0x254F4B )
	...
	ROM_REGION( 0x200000, "simm5.6", 0 )
	ROM_LOAD( "sfiii3-simm5_hc05.6", 0x00000, 0x200000, CRC(e6f6c399) SHA1(423fba19e2262081dde61e9e8e0beedb40f95d35) )
	ROM_IGNORE( 0x254F4A )
	ROM_REGION( 0x200000, "simm5.7", 0 )
	ROM_LOAD( "sfiii3-simm5_hc05.7", 0x00000, 0x200000, CRC(37ab0379) SHA1(eeb64c1374d8f2272ba32d4afa46ef191a82f7ce) )
    ROM_IGNORE( 0x254F4A )
...
/*    YEAR  NAME            PARENT    MACHINE        INPUT       CLASS                INIT      MONITOR     COMPANY        FULLNAME FLAGS */
// Hack/Homebrow
GAME( 2018, jojobahc01,     jojoban,  jojoba,        cps3_jojo,  cps3_hbmame,     init_jojoban,  ROT0,      "hack",        "JoJo's Bizarre Adventure (Enable Hidden Characters 2009-08-08)", 0 )
GAME( 2018, jojobahc02,     jojoban,  jojoba,        cps3_jojo,  cps3_state,      init_jojoba,   ROT0,      "hack",        "JoJo's Bizarre Adventure (Ex Super Version Edition)", 0 )
GAME( 2021, jojobahc03,     jojoban,  jojoba,        cps3_jojo,  cps3_state,      init_jojoba,   ROT0,      "hack",        "JoJo's Bizarre Adventure (Rainbow Edition v1.0.1 2021)", 0 )
GAME( 2009, jojohc01,       jojon,    jojo,          cps3_jojo,  cps3_hbmame,     init_jojon,    ROT0,      "hack",        "JoJo's Venture (Enable Hidden Characters 2009-07-09)", 0 )
...
GAME( 2016, sfiiihc01,      sfiiin,   sfiii,         cps3,       cps3_state,      init_sfiii,    ROT0,      "hack",        "Street Fighter III: New Generation (Simple Attack 2016-01-21)", 0 )
GAME( 2009, sfiiihc02,      sfiiin,   sfiii,         cps3,       cps3_hbmame,     init_sfiiin,   ROT0,      "hack",        "Street Fighter III: New Generation (Enable Hidden Characters 2009-08-08)", 0 )
GAMEL(1997, sfiii2hc01,     sfiii2n,  sfiii2,        cps3,       cps3_state,      init_sfiii2,   ROT0,      "hack",        "Street Fighter III 2nd Impact: Giant Attack (Enable Hidden Characters)", 0, layout_sfiii2 )
GAMEL(2016, sfiii2hc02,     sfiii2n,  sfiii2,        cps3,       cps3_state,      init_sfiii2,   ROT0,      "hack",        "Street Fighter III 2nd Impact: Giant Attack (Boss With Simple Attack Edition 2016-01-11)", 0, layout_sfiii2 )
GAMEL(2016, sfiii2hc03,     sfiii2n,  sfiii2,        cps3,       cps3_state,      init_sfiii2,   ROT0,      "hack",        "Street Fighter III 2nd Impact: Giant Attack (Hits The Second Time 2014-11-19)", 0, layout_sfiii2 )
GAME( 2022, sfiii3hc01,     sfiii3n,  sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (Widescreen Edition 2022-07-01)", 0 )
GAME( 2022, sfiii3hc02,     sfiii3n,  sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (Widescreen Edition 2022-09-08)", 0 )
GAME( 2014, sfiii3hc03,     sfiii3n,  sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (Hits the third time 2014-11-20)", 0 )
GAME( 2015, sfiii3hc04,     sfiii3n,  sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (Boss With Simple Attack Edition 2015-12-16)", 0 )
GAME( 2014, sfiii3hc05,     sfiii3n,  sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (4rd Arrange Edition 2013 Simplified 2014-11-16)", 0 )
GAME( 2013, sfiii3hc06,     sfiii3n,  sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (4rd Arrange Edition 2013-07-16)", 0 )
GAME( 1999, sfiii3hc07,     sfiii3n,  sfiii3,        cps3,       cps3_hbmame,     init_sfiii3n,  ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (Enable Hidden Characters)", 0 )
GAME( 2021, sfiii3hc08,     sfiii3n,  sfiii3,        cps3,       cps3_state,      init_sfiii3,   ROT0,      "hack",        "Street Fighter III 3rd Strike: Fight for the Future (THIRD Update 2021)", 0 )
