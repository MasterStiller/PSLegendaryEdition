...
static const struct CPS1config cps1_config_table[]=
{
    ...
    /* PSMAME BUILDS PLUS */
   {"dinohc358",   CPS_B_21_DEF, mapper_CD63B },
   {"dinohc359",   CPS_B_21_DEF, mapper_CD63B },
   {"captcommhc110",   CPS_B_21_BT3, mapper_CC63B,  0x36, 0x38, 0x34, 3 },
   {"punisherhc34",CPS_B_21_DEF, mapper_PS63B },
   {"sf2cehc40",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc41",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc43",   HACK_B_1,     mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc44",   HACK_B_1,     mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc45",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc46",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc47",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc51",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc52",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc53",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc54",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc57",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc59",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc60",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc61",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc62",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc63",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc64",   HACK_B_1,     mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc65",   HACK_B_1,     mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc66",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc67",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc69",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc73",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc75",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc76",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc78",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc79",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc80",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc81",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc82",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc85",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc90",   HACK_B_1,     mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc91",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc92",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc93",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc95",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc96",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc97",   HACK_B_1,     mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc98",   CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc102",  CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc104",  CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2cehc110",  CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc112",  CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2cehc115",  CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   ...
   {"sf2hfhc06",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"sf2hfhc07",   CPS_B_21_DEF, mapper_S9263B, 0x36 },
   {"wofhhc01",    CPS_B_21_DEF, mapper_TK263B, 0x36 },
   {"wofhhc02",    CPS_B_21_DEF, mapper_TK263B, 0x36 },
   {"dinopic3hc01",CPS_B_21_QS2, mapper_CD63B },
   {"sf2mdthc01",  CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2mdthc02",  CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
   {"sf2mdthc03",  CPS_B_21_DEF, mapper_S9263B, 0x36, 0, 0, 1 },
