...
ROM_START( captcommhc01 ) //captcommr1pmy
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cc_28dhc01.10f", 0x000000, 0x3024FA, CRC(ea8bebca) SHA1(38bd9dfa307c4486ac19ca45b4c7b8552b9257c8) )
...
ROM_START( captcommhc02 ) //captcommr1pmy
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cc_28dhc02.10f", 0x000000, 0x3024FA, CRC(b9625397) SHA1(5763bd8da4857f481e773b628b49236d72a44c07) )
...
ROM_START( dinohc01 ) //dinoxlb2
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cde_23hc01.8f",  0x000000, 0x80000, CRC(f9b0a08b) SHA1(c7c5e83f2be67ecc9437b96b6089f5523c0bc7dc) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc01.7f",  0x080000, 0x80000, CRC(bcedf0b5) SHA1(c7cff6202ff5f18b03a6891f33de839705571ffb) )
	ROM_LOAD16_WORD_SWAP( "cde_21a.6f", 0x100000, 0x80000, CRC(66d23de2) SHA1(19b8a365f630411d524d055459020f4c8cf930f1) )
	ROM_LOAD16_WORD_SWAP( "cde_20hc01.5f",  0x180000, 0x80000, CRC(36ce97ab) SHA1(c0b69a3d9e8d7d8458470caa1ae20d766b6c7972) )
...
ROM_START( dinohc02 ) //dinoext
	...
	ROM_LOAD16_WORD_SWAP( "cde_28dhc02.10f", 0x000000, 0x200000, CRC(a54b4c50) SHA1(be68456734de27d5fdba5d1e7fa63d355f6539c8) )
...
ROM_START( dinohc03 ) //dinosdj
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cde_23hc03.8f",  0x000000, 0x80000, CRC(ca9b534f) SHA1(c22ed71ad4d6bfb825d060b5538d9d877e5c7895) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc03.7f",  0x080000, 0x80000, CRC(df3260c2) SHA1(7a328531c559e41fdc4da6c91a5c69294af02c54) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc03.6f",  0x100000, 0x80000, CRC(db855662) SHA1(cf5281ecb4925c74469623cec251702704cc7cfe) )
	ROM_LOAD16_WORD_SWAP( "cde_20hc03.5f",  0x180000, 0x80000, CRC(e663b7a9) SHA1(cbc85bde140280b81e96152d327ca6b4e9c346fd) )
...
ROM_START( dinohc04 ) //dinosj
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cde_23hc04.8f",  0x000000, 0x80000, CRC(312670f5) SHA1(ff504e07cc3f5d33894afcd7a7d2b70022e61aab) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc04.7f",  0x080000, 0x80000, CRC(f74b5ab9) SHA1(182847ec69849583ef513d72f82967fcb0b96312) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc04.6f",  0x100000, 0x80000, CRC(2f9132a4) SHA1(4f24d9e44e1ebf9d76ad258029d181464ea987a6) )
	ROM_LOAD16_WORD_SWAP( "cde_20hc04.5f",  0x180000, 0x80000, CRC(75660aac) SHA1(6a521e1d2a632c26e53b83d2cc4b0edecfc1e68c) )
...
ROM_START( dinohc05 ) //dinotj2022
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cde_23hc05.8f",  0x000000, 0x80000, CRC(c4a2bc60) SHA1(03a237aa54c52b4387936edb8f3f8ebe968e166a) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc05.7f",  0x080000, 0x80000, CRC(44f28f0d) SHA1(c219e8f6dad44b760c78f3eb6d6265d257e07406) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc05.6f",  0x100000, 0x80000, CRC(26769e22) SHA1(95d36da3aeeb99f6dd74ef878a6477b361e15c62) )
	ROM_LOAD16_WORD_SWAP( "cde_20hc05.5f",  0x180000, 0x80000, CRC(4e655871) SHA1(4151440cf1c9b9ed84553a60276f9536887f61d8) )
...
ROM_START( dinohc06 ) //dinosj
	ROM_REGION( CODE_SIZE, "maincpu", 0 )
	ROM_LOAD16_WORD_SWAP( "cde_23hc06.8f",  0x000000, 0x80000, CRC(34a60e53) SHA1(77cc4879eeb7e344a12b0025925abdd4edac2dad) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc06.7f",  0x080000, 0x80000, CRC(8c28ca74) SHA1(d5e9c68888a8a7b1f4cfe8ac584e32015653f7f5) )
	ROM_LOAD16_WORD_SWAP( "cde_22hc04.6f",  0x100000, 0x80000, CRC(2f9132a4) SHA1(4f24d9e44e1ebf9d76ad258029d181464ea987a6) )
	ROM_LOAD16_WORD_SWAP( "cde_20hc04.5f",  0x180000, 0x80000, CRC(75660aac) SHA1(6a521e1d2a632c26e53b83d2cc4b0edecfc1e68c) )
...
GAME( 2018, punisherhc01, punisher, qsound,         punisher, cps_state,   init_punisher, ROT0,   "hack",      "The Punisher (Framework Version 2020 Multi-Mode Enhancement 2022-07-24)", MACHINE_SUPPORTS_SAVE )
